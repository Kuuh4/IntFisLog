...
void loop()
{
  ...
  // modo 0 - Slider para eixo X, Joystick para eixo Y, Botão 4 Para Clique, Botão 1 para mudar modo
      for(;modo == 0;){
  ...
  // modo 1 - Joystick para eixo X e Y, Botão 4 Para Clique, Botão 1 para mudar modo
    for(;modo == 1;){
